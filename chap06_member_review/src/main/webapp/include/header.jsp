<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	// 로그인시 유지를 위한 session 값 받기
	String loggedName = (String)session.getAttribute("name");//오브젝트로 온 것
...
<html lang="en">
  ...
  <body>
    <header id="header">
      <div class="container">
        <h1><a href="/chap06_member_review">JJANG051</a></h1>
        <nav id="gnb">
