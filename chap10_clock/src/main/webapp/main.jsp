...
<body>
	...
	<main id="main">
		<c:forEach items="${clockList }" var="clockDto" varStatus="loop">
			<div class="section" id="clock${loop.index }" style="background-image:url('upload_clock/${clockDto.clockRealImg}')">
				<div class="info">
					...
					<p class="price" data-splitting>CHF ${clockDto.price }</p>
				</div>
			</div>
		</c:forEach>
	</main>
