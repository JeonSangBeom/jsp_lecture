...
<main>
	<div class="container">
		...
		<div id="contents">
			...
			<!-- name이 중요 id와 class는 자바스크립트에서 사용하는 것 -->
				<table>
					<colgroup>
						<col style="width: 20%">
						<col style="width: 80%">
					...
					<tbody> 
						...
						<tr>
							...
							<td><select name="user_phone_first" class="short">
									<option value="010" selected>010</option>
									<option value="011">011</option>
									<option value="017">017</option>
								</select> 
								<input type="text" name="user_phone_middle" class="short"
								id="user_phone_middle" placeholder="전화번호를 입력하세요."> 
								<input
								type="text" name="user_phone_last" class="short"
								id="user_phone_last" placeholder="전화번호를 입력하세요."></td>
						</tr>
						<tr>
				...
				<div class="btns">
					...
					<!-- submit - 전송 방식으로 날아간다(위에 설정한 곳으로) -->
