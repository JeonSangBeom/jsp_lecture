		  		...
		  		<table>
		  			...
		  			<tbody>
		  				<tr>
		  					...
		  					<td>
		  						<input type="text" name="user_id" id="user_id" value="<%=loggedId %>" readonly>
		  						<!-- <input type="text" name="user_id" id="user_id" value="${sessionScope.id }" readonly(읽을 수만 있는 것)>
		  							 ㅇ disable : 비활성화(값을 입력해도 날아가지 못한다) / redonly : 읽을 수만 있는 것
		  							 ㅇ ${sessionScope.id } - el 방식
		  							 ㅇ %=loggedId %  - 해더에서 session을 받았고 현재 includ를 한 상태라 가능	-->
		  					</td>
		  				</tr>
		  				<tr>
