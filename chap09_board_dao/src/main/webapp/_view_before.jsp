...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	int no = Integer.parseInt(request.getParameter("no"));// 쿼리스트링으로 넘어온 no값을 가져와서 아래 boardDto에 던져준다
	BoardDao boardDao = new BoardDao();
	BoardDto boardDto = boardDao.getSelectOne(no); // hit의  증가와 나머지 컬럼에 값을 다 뽑아서 BoardDto에 던져 준다(리턴값이 BoardDto)
