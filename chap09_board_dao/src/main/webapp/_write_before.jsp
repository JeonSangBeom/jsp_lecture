...
<%@ include file="./include/header.jsp"  %>
    <main>
      <div class="inner">
		  ...
		  <div id="contents">
		  	...
		  	<form method="POST" action="write_process_before.jsp" id="join" class="form">
		  		<table>
		  			<colgroup>
		  				<col style="width:20%">
		  				<col style="width:80%">
		  			...
		  			<tbody>
		  				<tr>
		  					...
		  					<td>
		  						<input type="text" name="user_name" id="user_name" placeholder="이름를 입력하세요.">
		  					</td>
		  				</tr>
		  				<tr>
    ...
    <script>
    	...
    	*/
    	...
    	//summernote 적용 - 그림은 올라가지 않는다 (용량이 너무 커서)
    	//이미지 업로드 방식을 이용하여야 한다 - 특정 폴더에 저장하여 사용 - db에는 그 경로와 파일명을 저장하는 방식
