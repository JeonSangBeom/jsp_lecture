			...
			<div class="form">
				...
				<div class="prevAndNext">
					<div class="item">
						...
						<a
							href="View.do?no=${prevReplyBoardDto.no }&num=${prevReplyBoardDto.num}">${prevReplyBoardDto.subject }</a>
					</div>
					<div class="item">
						...
						<a
							href="View.do?no=${nextReplyBoardDto.no }&num=${nextReplyBoardDto.num}">${nextReplyBoardDto.subject }</a>
					</div>
				</div>
				...
				<div class="btns">
					<a href="BoardList.do" class="btn btnConfirm">글목록</a> <a
						href="Write.do" class="btn btnConfirm">글쓰기</a> <a
						href="ReplyWrite.do?no=${replyBoardDto.no }
